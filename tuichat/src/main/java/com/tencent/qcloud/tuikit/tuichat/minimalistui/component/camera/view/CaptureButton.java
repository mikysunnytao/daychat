...
public class CaptureButton extends View {
    ...
    private final int progress_color = 0xEE16AE16;            //进度条颜色 progress bar color
    private final int outside_color = 0xEEDCDCDC;             //外圆背景色 Outer circle background color
    private final int inside_color = 0xFFFFFFFF;              //内圆背景色 Inner circle background color
