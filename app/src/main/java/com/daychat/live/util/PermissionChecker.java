...
public class PermissionChecker {
    ...
    public boolean checkPermission() {
        ...
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.TIRAMISU){
            if (!addPermission(permissionsList,Manifest.permission.READ_MEDIA_VIDEO) && !addPermission(permissionsList,Manifest.permission.READ_MEDIA_IMAGES) &&!addPermission(permissionsList,Manifest.permission.READ_MEDIA_AUDIO)){
