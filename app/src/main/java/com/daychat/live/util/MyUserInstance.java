...
import com.daychat.live.model.entity.Filters;
import com.daychat.live.model.entity.GuardianInfo;
import com.daychat.live.model.entity.LiveCategory;
import com.daychat.live.model.entity.Profile;
import com.daychat.live.model.entity.UserConfig;
import com.daychat.live.model.entity.UserRegist;
import com.daychat.live.model.entity.UserTag;
import com.daychat.live.wxapi.WxPayBuilder;
...
import com.meiyinzb.nasinet.base.NasiSDK;
...
public class MyUserInstance {
    ...
    public static UserRegist userInfo_null = new UserRegist("0", "", "", "", "", "", "0", "0", "", new ArrayList<UserTag>(), 0, 1,  "", 0, "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", new Profile());
    ...
    public boolean hasToken() {
        ...
        return getUserinfo().getToken() != null && !getUserinfo().getToken().equals("");
    ...
    public boolean isVip() {
        if (!TextUtils.isEmpty(getUserinfo().getVip_date())) {
            return System.currentTimeMillis() < DateUtil.date2TimeStamp(MyUserInstance.getInstance().getUserinfo().getVip_date());
        } else {
            return false;
        }
    }
    ...
    public boolean isAnchor() {
        if (hasToken()) {
            if (null != userInfo) {
                return userInfo.getIs_anchor() != null && !userInfo.getIs_anchor().equals("0");
            } else {
                return false;
            }
        } else {
    ...
    public boolean isVip(UserRegist sender) {
        ...
        return System.currentTimeMillis() < DateUtil.date2TimeStamp(sender.getVip_date());
    }
