...
public class StringUtil {
    ...
    private static final StringBuilder sTimeStringBuilder;
...
//    }
    ...
    public static String getDurationText(long mms) {
        ...
        if (hours > 0) {
            ...
            sTimeStringBuilder.append(hours);
        ...
        if (minutes > 0) {
            ...
            sTimeStringBuilder.append(minutes);
            sTimeStringBuilder.append(":");
        } else {
        ...
        if (seconds > 0) {
            ...
            sTimeStringBuilder.append(seconds);
        } else {
            sTimeStringBuilder.append("00");
        }
