...
public class VideoCameraActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            savePath = getExternalFilesDir("").getPath() + File.separator + "videoeditor" + File.separator + "small_video";
        } else {
...
//                String path = FileUtil.saveBitmap("small_video", bitmap);
            ...
            public void recordSuccess(String url, Bitmap firstFrame) {
                //获取视频路径
                String path = new FileUtil(VideoCameraActivity.this).saveBitmap("small_video", firstFrame);
