...
import com.daychat.live.presenter.UpLoadPresenter;
import com.daychat.live.util.QNiuUploadUtils;
import com.daychat.live.util.StringUtil;
import com.daychat.live.util.ToastUtils;
import com.daychat.live.util.UploadUtils;
...
public class ShortVideoPublishActivity extends BaseMvpActivity<UpLoadPresenter> implements UploadContract.View {
    ...
    protected void initView() {
        ...
        mUploadUtils = new QNiuUploadUtils(this);
        mUploadUtils.getConfig();
        temp_video_url = getIntent().getStringExtra(MP4_PATH);
