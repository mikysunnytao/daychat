...
import com.daychat.live.view.DragItemAdapter;
...
public class VideoFrameActivity extends Activity {
    ...
    private final PLVideoSaveListener mVideoSaveListener = new PLVideoSaveListener() {
        ...
        public void onSaveVideoSuccess(final String destFile) {
            Uri uri = MediaStoreUtils.storeVideo(VideoFrameActivity.this, new File(destFile), "video/mp4");
            mProcessingDialog.dismiss();
//            PlaybackActivity.start(VideoFrameActivity.this, destFile);
//            File file = UriUtils.uri2File(uri);
            long duration = VideoUtils.getDuration(destFile);
            Intent intent = new Intent(VideoFrameActivity.this, ShortVideoPublishActivity.class);
            intent.putExtra(MP4_PATH,destFile);
