...
import com.daychat.live.base.SocketConstants;
        ...
        if (!TUILogin.isUserLogined()) {
            ...
            TUILogin.login(MyApp.getInstance(), sdkAppId, userId, userSign, new TUICallback() {
                ...
                public void onError(int errorCode, String errorMessage) {
                    Log.e("IMTAG", "error:"+errorMessage);
                }
            });
            initBaseListener();
...
//
//
//                        if (SocketConstants.LIVE_ACTION_GiftAnimation.equals(bean.getAction())) {
