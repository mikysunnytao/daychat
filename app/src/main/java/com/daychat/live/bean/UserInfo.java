...
import com.daychat.live.util.TUIKitConstants;
...
public class UserInfo implements Serializable {
    ...
    public synchronized static UserInfo getInstance() {
        if (sUserInfo == null) {
            SharedPreferences shareInfo = MyApp.instance().getSharedPreferences(TUIKitConstants.USERINFO, Context.MODE_PRIVATE);
