...
public class UserRegist implements Serializable {
    ...
    private String personal_mood;

    private String personalized_signature;

    public String getPersonal_mood() {
        return personal_mood;
    }

    public void setPersonal_mood(String personal_mood) {
        this.personal_mood = personal_mood;
    }
