...
public class TiMakeupView extends LinearLayout {
    ...
    private final List<TiMakeup> blusherList = new ArrayList<>();
    private final List<TiMakeup> eyelashList = new ArrayList<>();
    private final List<TiMakeup> eyebrowList = new ArrayList<>();
    private final List<TiMakeupText> blusherTextList = new ArrayList<>();
    private final List<TiMakeupText> eyelashTextList = new ArrayList<>();
    private final List<TiMakeupText> eyebrowTextList = new ArrayList<>();
