...
public class CreateGroupMinimalistActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final ArrayList<Object> groupAvatarUrlList = new ArrayList<>();
    ...
    private final ActivityResultCallback<String> groupTypeSelectedCallback = new ActivityResultCallback<String>() {
        @Override
