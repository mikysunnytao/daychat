...
public class ContactAdapter extends RecyclerView.Adapter<ContactAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ContactAdapter.ViewHolder holder, int position) {
        ...
        holder.tvDesc.setText("오늘의 기분: 참좋아요!");
        ...
        holder.btnSwitch.setOnClickListener(v->{
            contactBean.setTop(!contactBean.isTop());
        ...
        if (TextUtils.equals(TUIContactService.getAppContext().getResources().getString(R.string.new_friend), contactBean.getId())) {
            ...
            int radius = AdaptScreenUtils.pt2Px(75);//holder.itemView.getResources().getDimensionPixelSize(R.dimen.contact_profile_face_radius);
            if (isGroupList) {
