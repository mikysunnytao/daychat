            ...
            mContactListView.setOnItemClickListener(new ContactListView.OnItemClickListener() {
                ...
                public void onItemClick(int position, ContactItemBean contact) {
                    if (position == 0) {
                        ...
                        Intent i = new Intent();
                        i.putStringArrayListExtra(TUIContactConstants.Selection.USER_NAMECARD_SELECT, new ArrayList<String>(Collections.singletonList(getString(R.string.at_all))));
                        i.putStringArrayListExtra(TUIContactConstants.Selection.USER_ID_SELECT, new ArrayList<String>(Collections.singletonList(TUIContactConstants.Selection.SELECT_ALL)));
                        setResult(3, i);
