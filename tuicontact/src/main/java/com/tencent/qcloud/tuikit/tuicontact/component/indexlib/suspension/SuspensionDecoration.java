...
//        }
        ...
        int leftPos = AdaptScreenUtils.pt2Px(110);
        //child.getPaddingLeft() + 61
        c.drawText(mDatas.get(position).getSuspensionTag(),leftPos , child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
