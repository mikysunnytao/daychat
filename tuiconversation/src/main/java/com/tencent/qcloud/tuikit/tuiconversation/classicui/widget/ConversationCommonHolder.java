...
public class ConversationCommonHolder extends ConversationBaseHolder {
    ...
    protected ImageView unreadText;
    ...
    public ConversationCommonHolder(View itemView) {
        ...
        flTop = rootView.findViewById(R.id.fl_top);
    ...
    public void layoutViews(ConversationInfo conversation, int position) {
        ...
        if (conversation.getConversation().isPinned()){
            ivTop.setImageResource(R.drawable.favorite);
        }else {
            ivTop.setImageResource(R.drawable.favorite_default);
        }
        messageText.setText("");
