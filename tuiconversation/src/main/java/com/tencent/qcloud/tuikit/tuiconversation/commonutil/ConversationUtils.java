...
public class ConversationUtils {
    ...
    public static ConversationInfo convertV2TIMConversation(final V2TIMConversation conversation) {
        ...
        if (conversation.getMarkList() != null) {
            info.setMarkFold(conversation.getMarkList().contains(V2TIMConversation.V2TIM_CONVERSATION_MARK_TYPE_FOLD));
            info.setMarkUnread(conversation.getMarkList().contains(V2TIMConversation.V2TIM_CONVERSATION_MARK_TYPE_UNREAD));
            info.setMarkHidden(conversation.getMarkList().contains(V2TIMConversation.V2TIM_CONVERSATION_MARK_TYPE_HIDE));
        }
        return info;
    }
